...
public class ServiceConstants {
	...
	public static final String ADVOCATE_CLERK_CREATE_EXCEPTION = "ADVOCATE_CREATE_EXCEPTION";
	public static final String ADVOCATE_CLERK_SEARCH_EXCEPTION = "ADVOCATE_SEARCH_EXCEPTION";
	public static final String ADVOCATE_CLERK_SEARCH_QUERY_EXCEPTION = "ADVOCATE_SEARCH_QUERY_EXCEPTION";
