...
public class AdvocateClerkRegistrationValidator {
    ...
    public AdvocateClerk validateApplicationExistence(AdvocateClerk advocateClerk) {
        ...
        List<AdvocateClerk> existingApplications =  repository.getClerkApplications(Collections.singletonList(AdvocateClerkSearchCriteria.builder().applicationNumber(advocateClerk.getApplicationNumber()).build()), advocateClerk.getTenantId(), 1,0);
