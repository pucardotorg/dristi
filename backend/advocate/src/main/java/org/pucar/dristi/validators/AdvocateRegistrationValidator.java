...
public class AdvocateRegistrationValidator {
    ...
    public Advocate validateApplicationExistence(Advocate advocate) {
        ...
        List<AdvocateSearchCriteria> list = repository.getApplications(Collections.singletonList(AdvocateSearchCriteria.builder().applicationNumber(advocate.getApplicationNumber()).build()), new AtomicReference<>(false), advocate.getTenantId(), 1,0);
