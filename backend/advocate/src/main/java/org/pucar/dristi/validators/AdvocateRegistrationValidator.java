...
public class AdvocateRegistrationValidator {
    ...
    public Advocate validateApplicationExistence(Advocate advocate) {
        ...
        List<AdvocateSearchCriteria> list = repository.getAdvocateApplications(Collections.singletonList(AdvocateSearchCriteria.builder().applicationNumber(advocate.getApplicationNumber()).build()), advocate.getTenantId(), 1,0);
