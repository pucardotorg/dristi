 ...
 class AdvocateClerkRepositoryTest {
    ...
    @Test
     void testGetApplications() {
        ...
        List<AdvocateClerk> result = advocateClerkRepository.getClerkApplications(
    ...
    @Test
     void testGetApplications_Exception() {
        ...
        assertThrows(Exception.class, () -> advocateClerkRepository.getClerkApplications(
                searchCriteriaList, "tenantId", 10, 0));
    }
    ...
    public void testGetApplications_CustomException() {
        ...
        assertThrows(CustomException.class, () -> advocateClerkRepository.getClerkApplications(
                searchCriteriaList, "tenantId", 10, 0));
    }
