...
import static org.mockito.Mockito.*;
 ...
 class AdvocateRepositoryTest {
    ...
    void getApplications_Success() {
        ...
        // Act
        List<AdvocateSearchCriteria> result = advocateRepository.getAdvocateApplications(searchCriteria, tenantId, limit, offset);
    ...
    void getApplications_Exception() {
        ...
        // Assert
        assertThrows(Exception.class, () -> advocateRepository.getAdvocateApplications(searchCriteria, tenantId, limit, offset));
    }
    ...
    void getApplications_CustomException() {
        ...
        // Assert
        assertThrows(CustomException.class, () -> advocateRepository.getAdvocateApplications(searchCriteria, tenantId, limit, offset));
    }
