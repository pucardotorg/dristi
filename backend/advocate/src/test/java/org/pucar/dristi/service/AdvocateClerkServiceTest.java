...
@ExtendWith(MockitoExtension.class)
 class AdvocateClerkServiceTest {
    ...
    void searchAdvocateClerkApplications_IndividualLoggedInUser() {
        ...
        verify(advocateClerkRepository, times(1)).getClerkApplications(advocateClerkSearchCriteria, "testTenantId",   10, 0);
    }
    ...
    void searchAdvocateClerkApplications_Exception() {
        ...
        when(advocateClerkRepository.getClerkApplications(any(), any(), any(), any())).thenThrow(new RuntimeException());
    ...
    void searchAdvocateClerkApplications_CustomException() {
        ...
        when(advocateClerkRepository.getClerkApplications(any(), any(), any(), any())).thenThrow(new CustomException());
