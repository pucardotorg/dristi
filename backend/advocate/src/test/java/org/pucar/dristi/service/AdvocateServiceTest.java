 ...
 class AdvocateServiceTest {
    ...
    @Test
     void testSearchAdvocate() {
        ...
        when(advocateRepository.getAdvocateApplications(criteria, "tenantId", 10, 0)).thenReturn(new ArrayList<>());

        // Call the method under test
        advocateService.searchAdvocate(requestInfo, criteria, "tenantId", null, null);

        // Verify the repository interaction
        verify(advocateRepository).getAdvocateApplications(criteria, "tenantId", 10, 0);
    ...
    @Test
     void testSearchAdvocateCustomException() {
        ...
        doThrow(customException).when(advocateRepository).getAdvocateApplications(criteria, "tenantId", 10, 0);
