...
@ExtendWith(MockitoExtension.class)
 class AdvocateClerkRegistrationValidatorTest {
    ...
    void validateApplicationExistence_ApplicationExists() {
        ...
        when(repository.getClerkApplications(anyList(), anyString(), anyInt(), anyInt())).thenReturn(existingApplications);
    ...
    void validateApplicationExistence_ApplicationDoesNotExist() {
        ...
        when(repository.getClerkApplications(anyList(), anyString(), anyInt(), anyInt())).thenReturn(Collections.emptyList());
