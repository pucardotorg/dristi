...
//        ResponseEntity<AdvocateListResponse> response = controller.advocateV1CreatePost(requestBody);
//
//        // Verify response status and content
//        assertEquals(HttpStatus.OK, response.getStatusCode());
//        AdvocateListResponse actualResponse = response.getBody();
...
//
//        // Perform POST request
//        ResponseEntity<AdvocateListResponse> response = controller.advocateV1SearchPost(requestBody,1,1);
//
//        // Verify response status and content
//        assertEquals(HttpStatus.OK, response.getStatusCode());
//        AdvocateListResponse actualResponse = response.getBody();
...
//
//        // Perform POST request
//        ResponseEntity<AdvocateListResponse> response = controller.advocateV1UpdatePost(requestBody);
//
//        // Verify response status and content
//        assertEquals(HttpStatus.OK, response.getStatusCode());
//        AdvocateListResponse actualResponse = response.getBody();
