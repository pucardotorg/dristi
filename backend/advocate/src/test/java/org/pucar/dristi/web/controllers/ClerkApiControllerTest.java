...
public class ClerkApiControllerTest {
    ...
    @Mock
    private AdvocateClerkListResponse advocateClerkResponse;
...
//        advocateClerkResponse = new AdvocateClerkListResponse();
//        advocateClerkResponse = AdvocateClerkListResponse.builder().clerks(advocateList).responseInfo(responseInfo).build();
//
...
//
//        // Perform POST request
//        ResponseEntity<AdvocateClerkListResponse> response = clerkApiController.clerkV1SearchPost(requestBody,1,1);
//
//        // Verify response status and content
//        assertEquals(HttpStatus.OK, response.getStatusCode());
//        AdvocateClerkListResponse actualResponse = response.getBody();
...
//
//        // Perform POST request
//        ResponseEntity<AdvocateClerkListResponse> response = clerkApiController.clerkV1UpdatePost(requestBody);
//
//        // Verify response status and content
//        assertEquals(HttpStatus.OK, response.getStatusCode());
//        AdvocateClerkListResponse actualResponse = response.getBody();
