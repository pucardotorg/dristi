...
class AdvocateQueryBuilderTest {
    ...
    void testGetAdvocateSearchQuery() {
        ...
        String query = advocateQueryBuilder.getAdvocateSearchQuery(criteriaList, preparedStmtList,statusList, applicationNumber, new AtomicReference<>(true),1,1, new Pagination());
    ...
    void testGetAdvocateSearchQueryByApplicationNumber() {
        ...
        // Call the method to be tested
        String query = advocateQueryBuilder.getAdvocateSearchQuery(null, preparedStmtList,statusList, applicationNumber, new AtomicReference<>(true),1,1, new Pagination());
