...
//            log.info("Final document query: {}", linkedCaseQuery);
...
//            log.info("Final document query: {}", litigantQuery);
...
//            log.info("Final document query: {}", statueAndSectionQuery);
...
//            log.info("Final document query: {}", representativeQuery);
