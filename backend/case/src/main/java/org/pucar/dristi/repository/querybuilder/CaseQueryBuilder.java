...
public class CaseQueryBuilder {
    //TODO: Atul: When we say base case query, are we saying that we are going to get all columns from the case table? will select * not have worked?
    ...
    public String getCasesSearchQuery(CaseCriteria criteria, List<Object> preparedStmtList, List<Integer> preparedStmtArgList,RequestInfo requestInfo) {
        try {
            ...
            //TODO: Atul: Explain what does firstCriteria mean. What does it means if it is true or false?
    ...
    //TODO: Atul: What about the condition when registrationToDate is not specified? API spec says that we need to find cases as per registrationFromDate
    ...
    //TODO: Atul: What about the condition when filingToDate is not specified? API spec says that we need to find cases as per filingFromDate
    ...
    private boolean addAdvocateCriteria(CaseCriteria criteria, List<Object> preparedStmtList, List<Integer> preparedStmtArgList, RequestInfo requestInfo, StringBuilder query, boolean firstCriteria) {
        //TODO: Atul: Simplify the search logic, by using the createdBy field
