...
public class CaseManagerApiController {
	...
	@Autowired
	public CaseManagerApiController(ObjectMapper objectMapper, HttpServletRequest request, CaseManagerService caseManagerService, ResponseInfoFactory responseInfoFactory) {
