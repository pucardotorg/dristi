...
public class ApplicationUtil {
    ...
    public Boolean fetchApplicationDetails(ApplicationExistsRequest applicationExistsRequest) {
        ...
        return applicationExistsResponse.getApplicationExists().get(0).getExists();
    }
}