...
class HearingRegistrationEnrichmentTest {
    ...
    void enrichHearingRegistrationTest() {
        ...
        verify(idgenUtil, times(1)).getIdList(requestInfo, "tenantId", "hearing.id", null, 1);
    ...
    void enrichHearingRegistrationNoDocumentsTest() {
        ...
        hearingRequest.setRequestInfo(requestInfo);
        List<String> idList = List.of("Hearing123");
        when(idgenUtil.getIdList(any(), any(), anyString(), any(), anyInt())).thenReturn(idList);
    ...
    void enrichHearingRegistrationThrowsCustomExceptionTest() {
        ...
        when(idgenUtil.getIdList(any(), any(), anyString(), any(), anyInt())).thenThrow(new CustomException("ID_GENERATION_ERROR", "ID generation failed"));
    ...
    void enrichHearingRegistrationThrowsExceptionTest() {
        ...
        when(idgenUtil.getIdList(any(), any(), anyString(), any(), anyInt())).thenThrow(new RuntimeException("Random error"));
