...
public class OrderApiController {
    ...
    public ResponseEntity<OrderListResponse> orderV1SearchPost(@Parameter(in = ParameterIn.QUERY, description = "the applicationNumber whose order(s) are being queried", required = true, schema = @Schema()) @Valid @RequestParam(value = "applicationNumber", required = true) String applicationNumber,
                                                               @Parameter(in = ParameterIn.QUERY, description = "the filingNumber of the case whose order(s) are being queried", required = true, schema = @Schema()) @Valid @RequestParam(value = "filingNumber", required = true) String filingNumber,
                                                               @Parameter(in = ParameterIn.QUERY, description = "the cnrNumber of the case whose order(s) are being queried", required = true, schema = @Schema()) @Valid @RequestParam(value = "cnrNumber", required = true) String cnrNumber,
