...
class ServiceConstantsTest {
    ...
    void testConstants() {
        ...
        assertEquals("Exception occurred while fetching case details: ", ServiceConstants.ERROR_WHILE_FETCHING_FROM_CASE);
        assertEquals("Exception occurred while validating order details: ", ServiceConstants.CREATE_ORDER_ERR);
        assertEquals("MDMS data doesn't exist: ", ServiceConstants.MDMS_DATA_NOT_FOUND);
