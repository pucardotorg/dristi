...
public class ResponseInfoFactoryTest {
    ...
    public void testCreateResponseInfoFromRequestInfo_Success() {
        ...
        // Act
        ResponseInfo responseInfo = responseInfoFactory.createResponseInfoFromRequestInfo(requestInfo, true, "message");
        ...
        assertEquals("message", responseInfo.getResMsgId());
    ...
    public void testCreateResponseInfoFromRequestInfo_Failure() {
        ...
        // Act
        ResponseInfo responseInfo = responseInfoFactory.createResponseInfoFromRequestInfo(requestInfo, false, "message");
    ...
    public void testCreateResponseInfoFromRequestInfo_NullRequestInfo() {
        // Act
        ResponseInfo responseInfo = responseInfoFactory.createResponseInfoFromRequestInfo(null, true, "message");
