...
public class OrderApiControllerTest {
    ...
    public void testAdvocateV1SearchPost_Success() {
        ...
        when(orderRegistrationService.searchOrder(any(), any(), any(), any(),any(),any(),any(),any(),any()))
                .thenReturn(expectedAdvocates);
        ...
        // Perform POST request
        ResponseEntity<OrderListResponse> response = controller.orderV1SearchPost("03768157-7b6d-4215-84b9-da3d13d24005","filingNum","cnrNum","123","pg","CREATE","Bail","order-no",new RequestInfo());
    ...
    public void testAdvocateV1SearchPost_InvalidRequest() throws Exception {
        ...
        // Expected validation error
        when(orderRegistrationService.searchOrder(any(), any(), any(), any(),any(),any(),any(),any(),any())).thenThrow(new IllegalArgumentException("Invalid request"));

        // Perform POST request
        try {
             controller.orderV1SearchPost("03768157-7b6d-4215-84b9-da3d13d24005","filingNum","cnrNum","123","pg","CREATE","Bail","order-no",new RequestInfo());
        }
        catch (Exception e){
            assertInstanceOf(IllegalArgumentException.class, e);
            assertEquals("Invalid request", e.getMessage());
    ...
    public void testAdvocateV1SearchPost_EmptyList() throws Exception {
        ...
        when(orderRegistrationService.searchOrder(any(), any(), any(), any(),any(),any(),any(),any(),any())).thenReturn(emptyList);
