...
public class EPostConfigParamsTestBuilder {


    private EPostConfigParams.EPostConfigParamsBuilder builder;

    public EPostConfigParamsTestBuilder() {
        this.builder = EPostConfigParams.builder();
    }

    public static EPostConfigParamsTestBuilder builder() {
        return new EPostConfigParamsTestBuilder();
    }

    public EPostConfigParams build() {
        return this.builder.build();
    }

    public EPostConfigParamsTestBuilder withConfig() {
    ...
    public EPostConfigParamsTestBuilder withSpeedPost() {
