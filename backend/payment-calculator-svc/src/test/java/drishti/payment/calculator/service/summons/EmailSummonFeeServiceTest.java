...
public class EmailSummonFeeServiceTest {

    @Mock
    private SummonUtil summonUtil;

    @InjectMocks
    private EmailSummonFeeService emailSummonFeeService;
    ...
    public void doCalculateEmailSummonFee() {
        ...
        Calculation result = emailSummonFeeService.calculatePayment(new RequestInfo(), criteria);
