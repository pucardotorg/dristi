...
public class TaskApiController {
    ...
    public ResponseEntity<TaskListResponse> taskV1SearchPost(@Parameter(in = ParameterIn.DEFAULT, description = "RequestInfo for the creation of task", required = true, schema = @Schema()) @Valid @RequestBody RequestInfoWrapper requestInfoWrapper,
