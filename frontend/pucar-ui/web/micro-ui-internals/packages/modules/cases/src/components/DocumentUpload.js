...
import { LabelFieldPair, MultiUploadWrapper } from '@egovernments/digit-ui-react-components'
...
const DocumentUpload = ({module="Project", config, Controller, control, register, formData, errors, localePrefix, customClass, customErrorMsg,mdmsModuleName='pucar-ui'}) => {
