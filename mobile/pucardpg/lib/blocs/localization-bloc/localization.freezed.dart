...
mixin _$LocalizationEvent {
  ...
  List<Modules>? get moduleList => throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult when<TResult extends Object?>({
    required TResult Function(String? locale, List<Modules>? moduleList)
        onSelect,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(String? locale, List<Modules>? moduleList)? onSelect,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class $LocalizationEventCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? locale, List<Modules>? moduleList});
}
...
class _$LocaleSelectedEventImpl implements _LocaleSelectedEvent {
  const _$LocaleSelectedEventImpl(
      {this.locale, final List<Modules>? moduleList})
      : _moduleList = moduleList;

  @override
  final String? locale;
  final List<Modules>? _moduleList;
  @override
  List<Modules>? get moduleList {
    final value = _moduleList;
  ...
  int get hashCode => Object.hash(
      runtimeType, locale, const DeepCollectionEquality().hash(_moduleList));
...
abstract class _LocaleSelectedEvent implements LocalizationEvent {
  const factory _LocaleSelectedEvent(
      {final String? locale,
      final List<Modules>? moduleList}) = _$LocaleSelectedEventImpl;
