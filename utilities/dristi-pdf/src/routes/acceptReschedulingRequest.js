...
const { search_individual_uuid, search_case, search_order, search_hearing, search_mdms_order, search_hrms, search_individual, create_pdf, search_application } = require("../api");
...
router.post(
    ...
    asyncMiddleware(async function (req, res, next) {
        ...
        try {
            ...
            var pdfResponse;
            const pdfKey = config.pdf.accept_rescheduling_request;
            try {
                ...
                return renderError(res, "Failed to generate PDF for accept reschedule request", 500, ex);
            }
            ...
            return renderError(res, "Failed to query details of accept reschedule request", 500, ex);
        }
    })
);
