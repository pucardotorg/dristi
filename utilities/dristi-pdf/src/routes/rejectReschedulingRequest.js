...
const { search_application, search_case, search_order, search_hearing, search_mdms_order, search_hrms, search_individual,search_individual_uuid, create_pdf } = require("../api");
...
router.post(
    ...
    asyncMiddleware(async function (req, res, next) {
        ...
        try {
            ...
            var pdfResponse;
            const pdfKey = config.pdf.reject_rescheduling_request;
            try {
            ...
            return renderError(res, "Failed to query details of reject reschedule request", 500, ex);
        }
    })
);
