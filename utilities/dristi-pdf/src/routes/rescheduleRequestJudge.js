...
const {  search_case, search_order, search_hearing, search_mdms_order, search_hrms, search_individual, create_pdf,search_application } = require("../api");
...
router.post(
    ...
    asyncMiddleware(async function (req, res, next) {
        ...
        try {
            ...
            var pdfResponse;
            const pdfKey = config.pdf.reschedule_request_judge;
            try {
